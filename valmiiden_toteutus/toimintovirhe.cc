...
namespace
{
    ...
    Virheviestit::value_type const VIRHEVIESTIARVOT[] = {
			...
			Virheviesti(
					Toimintovirhe::VIRHE_IRTOPALAN_PAIKKA,
					"Irtopalan paikka on virheellinen."
				),
			Virheviesti(
					Toimintovirhe::VIRHE_IRTOPALAN_REUNA,
					"Irtopalan reuna on virheellinen."
				),
			Virheviesti(
					Toimintovirhe::VIRHE_IRTOPALAN_ROTAATIO,
					"Irtopalan suunta on virheellinen."
				),
			Virheviesti(
			...
			Virheviesti(
					Toimintovirhe::VIRHE_PELAAJA_ON_JO_LIIKKUNUT,
					"Pelaajaa on jo liikkunut talla vuorolla."
				),
			Virheviesti(
				Toimintovirhe::VIRHE_LIIKKEEN_SUUNTA,
				"Liikeen suunta on virheellinen."
			),
            Virheviesti(
