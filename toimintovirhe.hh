	...
	class Toimintovirhe : public Virhe
	{
		public:
            ...
            Virhekoodi
            {
				...
				/**
				*	\brief Irtopalan paikka on virheellinen.
				*/
				VIRHE_IRTOPALAN_PAIKKA,
				/**
				*	\brief Irtopalan reuna on virheellinen.
				*/
				VIRHE_IRTOPALAN_REUNA,
				/**
				*	\brief Irtopalan rotaatio on virheellinen.
				*/
				VIRHE_IRTOPALAN_ROTAATIO,
				/**
				 *	\brief Pelaaja ei ole liikkunut tällä vuorolla.
				 */
				VIRHE_PELAAJA_EI_OLE_LIIKKUNUT,
				/**
				*	\brief Pelaaja on jo liikkunut tällä vuorolla.
				*/
				VIRHE_PELAAJA_ON_JO_LIIKKUNUT,
				/**
				*	\brief Liikeen suunta on virheellinen.
				*/
				VIRHE_LIIKKEEN_SUUNTA,
                /**
